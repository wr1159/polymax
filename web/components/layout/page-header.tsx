...
function PageHeaderHeading({
  ...
  return (
    <motion.h1
      ...
      className={cn(
        "bg-gradient-to-br from-black to-stone-500 bg-clip-text text-left text-4xl font-bold leading-tight tracking-tight text-transparent drop-shadow-sm dark:from-stone-100 dark:to-yellow-200 md:text-8xl md:leading-[6rem] lg:leading-[1.1]",
        className
      )}
      {...props}
    >
...
function PageHeaderDescription({
  ...
  return (
    <motion.p
      variants={fadeDownVariant()}
      className={cn(
        "text-left text-lg text-muted-foreground md:text-xl",
        className
      )}
      {...props}
    >
